<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="EditForm.aspx.cs" Inherits="student_EditForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <p class="h4 text-center mb-4"><b>Edit Form</b></p>
   <hr />
        <div class="row">
             <div class="col-md-3"></div>  
            <div class="col-md-6">
                <label for="Sname" class="white-text">Student Name</label>
                <asp:TextBox ID="Sname" runat="server"  ontextchanged="Sname_TextChanged" pattern="[a-zA-Z\s]+" required  cssclass="form-control"></asp:TextBox>                                                                                                             
            </div>
            </div>
            <br />
            <div class="row">    
    ...
    <br /><label for="Sclass" class="white-text">Class</label>
          ...
          <asp:TextBox ID="S_income" runat="server" tittle="Enter only numeric" pattern="^[0-9]" cssclass="form-control"></asp:TextBox>
         </div>
                </div><br /><br />
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <asp:TextBox ID="Anumber" runat="server" tittle="Enter 11 digit Account number" pattern="[\\d{11}]" cssclass="form-control"></asp:TextBox>                                                                                                             
            </div>
            </div>
            <br />
            <div class="row"> 
            ...
            <div class="text-center py-4 mt-3">
                ...
                <div class="col-md-4">
            <div class="text-center py-4 mt-3">
                <asp:Button ID="Button2" runat="server" Text="Clear" cssclass="btn btn-danger btn-md" OnClick="Button2_Click"/>
            </div>
                    </div>
                </div>
            </div>
